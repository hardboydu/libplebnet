...
#define PAD64_REQUIRED
	...
	{ AS(sys_read_args), (sy_call_t *)sys_read, AUE_READ, NULL, 0, 0, 0, SY_THR_STATIC },	/* 3 = sys_read */
	{ AS(sys_write_args), (sy_call_t *)sys_write, AUE_WRITE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 4 = sys_write */
